const translations = {
  en: {
    ...
    settings: {
      ...
      workStart: "Start",
      workEnd: "End",
      workHoursHint: "AI and default suggestions use this as a reference for work-focused actions.",
  ...
  pt: {
    ...
    settings: {
      ...
      workStart: "Início",
      workEnd: "Fim",
      workHoursHint: "A IA e as sugestões padrão usam isso como referência para ações de trabalho.",
